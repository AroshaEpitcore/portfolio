  ...
  return (
    <LampContainer className={className}>
      <motion.h2
        ...
        className="mt-8 bg-gradient-to-br from-foreground to-muted-foreground bg-clip-text py-4 text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
        {title}
      </motion.h2>
      {description && (
